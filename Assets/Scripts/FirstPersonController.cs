...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                GetComponent<KeyManager>().ThrowKey(transform.position, Camera.main.transform);
                GetComponent<PlayerMovementRecorder>().CurrentInteraction = RecordInfo.Interaction.Fire;
            }
